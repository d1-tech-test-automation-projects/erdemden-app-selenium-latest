...
public class BaseStep extends LogTest {
    ...
    private static final String DEFAULT_URL = "https://testerdemden.d1-tech.com/login";
    ...
    public static WebElement findElementClassNameWithWait(String className, int timeoutSeconds) {
        try {
            ...
            TakeScreenShot.takeFailureScreenshot("findElementClassNameWithWait", driver,
                    "Element not found: " + className);
    ...
    public static WebElement findElementCssSelectorWithWait(String cssSelector, int timeoutSeconds) {
        try {
            ...
            TakeScreenShot.takeFailureScreenshot("findElementCssSelectorWithWait", driver,
                    "Element not found: " + cssSelector);
            logException("Finding element by CSS selector with wait", e);
            throw new NoSuchElementException("Element not found after " + timeoutSeconds + " seconds: " + cssSelector,
                    e);
        }
    }
    ...
    public static WebElement findElementLinkTextWithWait(String linkText, int timeoutSeconds) {
        try {
            ...
            TakeScreenShot.takeFailureScreenshot("findElementLinkTextWithWait", driver,
    ...
    public static void selectElementFromDropdown(WebElement dropdown, String optionText, String dropdownDescription) {
        try {
            ...
            TakeScreenShot.takeFailureScreenshot("selectElementFromDropdown", driver,
                    "Failed to select: " + optionText);
