 ...
 */
@Suite
@SuiteDisplayName("Erdemden All Modules Test Suite")
    @SelectClasses({
            /*ErdemdenHomeModuleTest.class,*/
            ErdemdenRealEstateModuleTest.class,
            ErdemdenVehicleModuleTest.class,
            /*ErdemdenAboutUsModuleTest.class,
            ErdemdenAdminPanelModuleTest.class*/
    })
@ConfigurationParameter(
        key = "junit.jupiter.testclass.order.default",
        value = "org.junit.jupiter.api.ClassOrderer$OrderAnnotation"
)
public class ErdemdenAllModulesSuite {
